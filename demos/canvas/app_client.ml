...
let draw ctx (color, size, (x1, y1), (x2, y2)) =
  ((let a9749a362 : (< .. > as 'a84e5e852) Js.t = ctx in
   ...
   let _x (ad71a6f91 : 'aedbaf2bf) = (ad71a6f91#stroke : 'ad3e1c974 Js.meth)
